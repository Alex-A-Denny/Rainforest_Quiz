 ...
 * UserFileDAO.java
 * 
 * This class provides a file-based implementation of the UserDAO interface.
 * It uses a TreeMap to store User objects and serializes them to a JSON file.
 * 
 * This code is no longer in use, as the application has transitioned to using a MySQL database for user persistence.
 * The UserMySQLDAO class now handles user data access and management.
 */
